# nvim-treesitter-queries-roc

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-roc/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-roc/actions/workflows/validate.yml)

Neovim tree-sitter queries for **roc**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-roc",
...
- [ ] Changes are scoped to `roc` — do not include files for other languages
